...
public enum Messages
{
    ...
    // START: Tau's fork
    BannedFromClaim("You are banned from this claim."),
    CannotBanManager("Could not ban {0} from claim at {1} as they are a manager of it.", "{0} is the manager name {1} is the claim location"),
    PlayerBannedFromClaim("Player has been banned from this claim."),
    PlayerBannedFromClaims("Player has been banned from all of your claims."),
    PlayerUnBannedFromClaim("Player has been unbanned from your claim."),
    PlayerUnBannedFromClaims("Player has been unbanned from all of your claims."),
    BanListNoClaim("Stand inside the claim you're curious about."),
    BanListHeader("Banned Players:"),
    TooManyPlayersClaimBanned("Too many players banned from claim: {0}", "{0} is the claim location"),
    PistonExploded("The piston at {0} exploded because it couldn't enter the claim at {1}", "{0} is the xyz of the piston, {1} is the claim location"),
    Create2DSubdivisionFail3DClaim("You can't create 2D subdivisions in 3D claims. Use /subdivideclaims3d to create 3D subdivisions."),
    _3DClaimsMode("3D claims mode. Select two opposing corners to create a 3D claim"),
    LocationClaimed("Your location has been claimed by {0}.", "0: claim owner"),
    _3DSubdivisionMode("3D Subdivision mode.  Use your shovel to create subdivisions in your existing claims.  Use /basicclaims to exit."),
    _3DAdminClaimsMode("3D Administrative claims mode active.  Any claims created will be free and editable by other administrators.");
    // END: Tau's fork
